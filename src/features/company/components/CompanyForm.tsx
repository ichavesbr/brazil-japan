...
export function CompanyForm({ defaultValues = null, onSubmit, onCancel }: CompanyFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 p-4 border rounded shadow-md">
      ...
      <div>
        <Label>Status</Label>
        <Select value={status} onValueChange={(value: CompanyStatus) => setStatus(value)} required>
          <SelectTrigger>
